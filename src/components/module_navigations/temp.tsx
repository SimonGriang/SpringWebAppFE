  ...
  return (
    ...
    >
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
            {ModuleIcon && (
              <span style={{ flexShrink: 0, marginTop: 2 }}>
                <ModuleIcon size={20} color={textColor} />
              </span>
            )}
            {/* Titel + Subtitle dürfen umbrechen — kein truncate */}
      ...
      {collapsed && ModuleIcon && (
        ...
        >
          <Tooltip label={moduleTitle} position="right" withArrow>
            <span>
              <ModuleIcon size={20} color={textColor} />
            </span>
          </Tooltip>
              ...
              {item.group ? (
                collapsed ? (
                  ...
                  <div style={{ padding: "12px 12px 4px 12px" }}>
                    {/* Dekorative Linie + Text — kein truncate, Umbruch erlaubt */}
                    <div style={{ display: "flex", alignItems: "flex-start", gap: 6 }}>
                      <div
                        style={{
                          ...
                          minHeight: 14,
                          borderRadius: 99,
                          backgroundColor: hexToRgba(textColor, 0.35),
                          flexShrink: 0,
                          marginTop: 3,
                          alignSelf: "stretch",
                        }}
